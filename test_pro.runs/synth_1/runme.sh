...
HD_PWD='C:/Users/khazi/projects/MasterThesis/test_pro/test_pro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matMult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matMult.tcl
